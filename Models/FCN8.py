...
# crop o1 wrt o2
def crop(o1, o2, i, data_format="channels_first"):
    ...
    if outputWidth1 > outputWidth2:
        o1 = Cropping2D(cropping=((0, 0), (0, cx)), data_format=data_format)(o1)
    else:
        o2 = Cropping2D(cropping=((0, 0), (0, cx)), data_format=data_format)(o2)

    if outputHeight1 > outputHeight2:
        o1 = Cropping2D(cropping=((0, cy), (0, 0)), data_format=data_format)(o1)
    else:
        o2 = Cropping2D(cropping=((0, cy), (0, 0)), data_format=data_format)(o2)

    return o1, o2


def FCN8(nClasses, input_height=416, input_width=608, vgg_level=3, data_format="channels_first"):
    ...
    o = (Conv2D(4096, (7, 7), activation='relu', padding='same', data_format=data_format))(o)
    o = Dropout(0.5)(o)
    o = (Conv2D(4096, (1, 1), activation='relu', padding='same', data_format=data_format))(o)
    o = Dropout(0.5)(o)

    o = (Conv2D(nClasses, (1, 1), kernel_initializer='he_normal', data_format=data_format))(o)
    o = Conv2DTranspose(nClasses, kernel_size=(4, 4), strides=(2, 2), use_bias=False, data_format=data_format)(o)

    o2 = f4
    o2 = (Conv2D(nClasses, (1, 1), kernel_initializer='he_normal', data_format=data_format))(o2)

    o, o2 = crop(o, o2, img_input, data_format)
    ...
    o = Conv2DTranspose(nClasses, kernel_size=(16, 16), strides=(8, 8), use_bias=False, data_format=data_format)(o)
