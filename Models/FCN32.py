...
def FCN32(n_classes, input_height=416, input_width=608, vgg_level=3, data_format="channels_first"):
    ...
    o = (Conv2D(n_classes, (1, 1), kernel_initializer='he_normal', data_format=data_format))(o)
    o = Conv2DTranspose(n_classes, kernel_size=(64, 64), strides=(32, 32), use_bias=False, data_format=data_format)(
        o)
